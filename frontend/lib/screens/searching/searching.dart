...
class _FlightSearchCardState extends State<_FlightSearchCard>
  ...
  Future<void> _handleSearch() async {
    ...
    // TODO: Replace with real backend search call
    // e.g. final result = await FlightService.search(from, to, date, passengers, class);
    await Future.delayed(
      const Duration(milliseconds: 1200),
    ); // simulate network
    final bool found = true; // TODO: replace with actual result from backend
